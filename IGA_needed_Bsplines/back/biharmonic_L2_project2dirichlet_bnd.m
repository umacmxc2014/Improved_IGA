...
np=pu + 2 ;% 每一条边上的数值积分点的个数.
 ...
 u_h_g2=A\rhs;
  ...
  err_g2=[0,0];% err_g2(1)存储的是g2-梯度\Pi \tilde{g}的L2误差。
  % err_g2(２)存储的是g2-梯度\Pi \tilde{g}与的Pi \tilde{g}的L2内积。
...
s=[Ae,Fe];
 ...
 function [s,s_inner_product]=quad_err_L2_biharmonic(u,Ubar,Vbar, Qw,  ConPts,weights,knotU,knotV, pu,pv, uspan, u_h_g1, u_h_g2, g2)
...
D_u_g2_n= u_h_g2(uspan-pu:uspan)' * DB_i2_n ;% g1 的 L2 投影的梯度点乘 n.
 ...
 s_inner_product=(g2(C(1),C(2)) - D_u_g1_n - D_u_g2_n  )*(D_u_g1_n + D_u_g2_n)*J;
